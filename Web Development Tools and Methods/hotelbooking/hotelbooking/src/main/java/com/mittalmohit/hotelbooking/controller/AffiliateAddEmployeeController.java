...
@Controller
@RequestMapping({"/views/affiliateworkflow/addemployee"})
public class AffiliateAddEmployeeController {
	...
	protected String doGet(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		System.out.print("Affiliate Add Employee Controller");
		return "/affiliateworkflow/addemployee";
	}
