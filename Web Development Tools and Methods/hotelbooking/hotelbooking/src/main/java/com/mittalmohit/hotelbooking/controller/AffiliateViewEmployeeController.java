...
@Controller
@RequestMapping({"/views/affiliateworkflow/viewemployees"})
public class AffiliateViewEmployeeController {
	...
	protected String doGet(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		System.out.print("Affiliate View Employee Controller");
		return "/affiliateworkflow/viewemployees";
	}
