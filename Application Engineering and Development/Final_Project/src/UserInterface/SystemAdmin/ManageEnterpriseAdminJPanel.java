...
public class ManageEnterpriseAdminJPanel extends javax.swing.JPanel {
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        if(nameJTextField.getText().trim().length()==0 || String.valueOf(passwordJPasswordField.getPassword()).trim().length()==0 || usernameJTextField.getText().trim().length()==0)
        {
        ...
        if( enterprise.getEnterpriseType().getValue().equals ("City")){
            UserAccount account = enterprise.getUserAccountDirectory().createUserAccount(username,
                                  password, employee, new CityAdminRole());
        }else if ( enterprise.getEnterpriseType().getValue().equals ("Emergency Room")){
            UserAccount account = enterprise.getUserAccountDirectory().createUserAccount(username,
                                  password, employee, new ERAdminRole());
        }else if ( enterprise.getEnterpriseType().getValue().equals ("Primary Doctor's Clinic")){
            UserAccount account = enterprise.getUserAccountDirectory().createUserAccount(username,
                                  password, employee, new PDCAdminRole());
        }
        JOptionPane.showMessageDialog(null,"New " + enterprise.getEnterpriseType().getValue() + " Admin created");    
        populateTable();
